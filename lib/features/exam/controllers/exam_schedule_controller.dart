...
class ExamScheduleController extends GetxController {
  final ExamScheduleService _service = Get.find<ExamScheduleService>();
  ...
  List<ExamScheduleModel> schedulesForClass({
    ...
    return _service.schedulesForClass(className: className, section: section);
  }
}
